...
| **CSS bundle**           | <!-- AUTO:CSS_TOTAL_RAW -->21.9<!-- /AUTO --> KB raw / <!-- AUTO:CSS_TOTAL_GZIP -->5.9<!-- /AUTO --> KB gzip (inline + deferred) | <!-- AUTO:BUDGET_CSS_MAX -->7.5<!-- /AUTO --> KB gzip  | ✅     |
| **Total bundle**         | <!-- AUTO:TOTAL_RAW -->24.5<!-- /AUTO --> KB raw / <!-- AUTO:TOTAL_GZIP -->7.1<!-- /AUTO --> KB gzip                             | <!-- AUTO:BUDGET_TOTAL_MAX -->10<!-- /AUTO --> KB gzip | ✅     |
