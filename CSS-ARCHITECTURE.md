...
| ----------------------------- | ---------------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| **Critical** (above-the-fold) | fonts, 1-variables, 2-reset, 4-header, 5-hero, 7-responsive      | inlined into `<style>` in index.html | ~<!-- AUTO:CSS_INLINE_RAW -->13.0<!-- /AUTO --> KB raw / ~<!-- AUTO:CSS_INLINE_GZIP -->3.5<!-- /AUTO --> KB gzip    |
