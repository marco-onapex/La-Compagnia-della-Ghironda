...
- CSS critical (inlined in HTML): ~<!-- AUTO:CSS_INLINE_RAW -->13.0<!-- /AUTO --> KB raw / ~<!-- AUTO:CSS_INLINE_GZIP -->3.5<!-- /AUTO --> KB gzip
...
- **Total raw: ~<!-- AUTO:TOTAL_RAW -->24.5<!-- /AUTO --> KB; gzip: ~<!-- AUTO:TOTAL_GZIP -->7.1<!-- /AUTO --> KB** (sotto budget <!-- AUTO:BUDGET_TOTAL_MAX -->10<!-- /AUTO --> KB gzip)
