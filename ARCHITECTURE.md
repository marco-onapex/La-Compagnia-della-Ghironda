...
- **Project size**: <!-- AUTO:LOC_HTML -->395<!-- /AUTO --> HTML lines, <!-- AUTO:LOC_JS_PROD -->726<!-- /AUTO --> JS lines (incl. `sw.js`), <!-- AUTO:LOC_CSS -->2109<!-- /AUTO --> CSS lines (auto-injected; values track the live source)
